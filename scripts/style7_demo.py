"""Style 7 demo — tree with theme tags and chevrons with real @bt data."""
...
# Platform Expansion
p = tree.add('[bold]Platform Expansion[/bold]  [dim italic]#platform[/dim italic]')
...
# AI Integration
a = tree.add('[bold]AI Integration[/bold]  [dim italic]#ai[/dim italic]')
...
m = tree.add('[bold]Mobile & Remote Access[/bold]  [dim italic]#mobile[/dim italic]')
m.add('  › add mobile access for bt')
m.add('  › create bt slide deck to present features')

# Community
c = tree.add('[bold]Community & Feedback[/bold]  [dim italic]#community[/dim italic]')
c.add('  › share bullet-terminal on reddit for feedback')

# Core Development
d = tree.add('[dim]Core Development[/dim]  [dim italic]#core [Complete][/dim italic]')
...
# Tensions
t = tree.add('[bold yellow]Tensions / Gaps[/bold yellow]  [dim italic]#gaps[/dim italic]')
