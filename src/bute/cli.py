...
def _print_help():
    ...
    t.add_row("@@tag", "Double duty — files it, keeps the word in place", "bt j lunch with @@Sam")
    ...
    t.add_row("bt trash", "Trashed entries", "bt trash purge -y to delete all")
    console.print()
    console.print(t)
    console.print()
    ...
    t.add_row("bt <n> purge", "Delete from trash for good (after bt trash)", "bt trash → bt 1 purge")
