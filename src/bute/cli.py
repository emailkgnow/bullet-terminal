...
def _print_help():
    ...
    t.add_row("due:<date>", "Deadline — tasks only", "bt t file taxes due:friday")
    t.add_row("date:<date>", "Scheduled day — events, or resurface a note", "bt n check OAuth docs date:04-10")
